...
import { Isabelle_square, Michael_square } from "../../assets";
...
const AdminPage = () => {
  ...
  if (isSuccess) localStorage.setItem("carvalet_user", userInfo.first_name);
  return (
      ...
      <div className="user-info-container">
        <div className="user-profile-overview">
          <div className="user-about">
            ...
            <p>
              I am often frustrated when having to deal with street parking and
              don't like having to pay expensive fees for parking lots.{" "}
            </p>
          </div>
