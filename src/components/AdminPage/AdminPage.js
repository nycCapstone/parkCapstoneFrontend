      ...
      <div className="admin-page">
        <div className= "user-profile-container">
          ...
          <div className="roles">
            <div className="role-list">
              ...
              <div className="role-item">
                {userInfo.roles.ClientOnly && 
                        <h4>Driver Account</h4>}
                {!userInfo.roles.ClientOnly && 
                        <h4>Spot Owner Account</h4>}
              </div>
            </div>
          </div>
            <div className="user-profile-picture-box">
              <div className="profile-picture-div">
            <img className="profile-picture" src="https://st3.depositphotos.com/6672868/13701/v/450/depositphotos_137014128-stock-illustration-user-profile-icon.jpg"/>
            </div>
            ...
            <div className="user-insights">
              <div className="insight">
                <span className="rating-number">4.97 <IoIosStar className="star" /></span> 
        ...
        <div className = "user-info-container">
          ...
          <div className="user-about"> 
              ...
              <p>I am often frustrated having to deal with street parking and doesn’t like having to pay expensive fees for parking lots. </p>
          </div>
          ...
          <div className="user-reviews">
            ...
            <div className="user-review-sample">
              <div className="review">
                <span className="review-text"><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit</p>
                <div className="reviewer-info">
                  <div className="reviewer-pfp-box">
                  <img className="reviewer-pfp" src="https://st3.depositphotos.com/6672868/13701/v/450/depositphotos_137014128-stock-illustration-user-profile-icon.jpg"/>
                  ...
                  <div className="review-1star">
                   <IoIosStar className="star" />  <p className="star">5</p>
                   </div>
          ...
          <div className="user-listing">
            ...
            <div className="listing-box">
             <span className="listing">
              <img className="listing-photo" src="https://media.npr.org/assets/img/2013/06/14/parking_wide-c0a616c65dc3a049ff06c4e95844202491483669.jpg"/>
             </span>
             <span className="listing">
             <img className="listing-photo" src="https://media.npr.org/assets/img/2013/06/14/parking_wide-c0a616c65dc3a049ff06c4e95844202491483669.jpg"/>
             </span>
